...
func (t *CmdObjectComplianceCheck) Init(kind string, parent *cobra.Command, selector *string) {
	cmd := t.cmd(kind, selector)
	parent.AddCommand(cmd)
	flag.Install(cmd, t)
}

func (t *CmdObjectComplianceCheck) cmd(kind string, selector *string) *cobra.Command {
...
func (t *CmdObjectComplianceCheck) run(selector *string, kind string) {
