...
type (
	// CmdObjectPRStop is the cobra flag set of the start command.
...
func (t *CmdObjectPRStop) Init(kind string, parent *cobra.Command, selector *string) {
	cmd := t.cmd(kind, selector)
	parent.AddCommand(cmd)
	flag.Install(cmd, t)
}

func (t *CmdObjectPRStop) cmd(kind string, selector *string) *cobra.Command {
...
func (t *CmdObjectPRStop) run(selector *string, kind string) {
