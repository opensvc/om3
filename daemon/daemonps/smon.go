...
func PubSmonDelete(bus *pubsub.Bus, id string, v moncmd.SmonDeleted) {
	Pub(bus, NsSmon, pubsub.OpDelete, id, v)
}

func PubSmonUpdated(bus *pubsub.Bus, id string, v moncmd.SmonUpdated) {
...
func PubSetSmonUpdated(bus *pubsub.Bus, id string, v moncmd.SetSmon) {
