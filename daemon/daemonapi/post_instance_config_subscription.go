...
// PostInstanceConfigSubscription creates new subscription for instance Config Events in sse format.
// TODO: Honor namespace and selection parameters.
// TODO: Honor grants
func (a *DaemonApi) PostInstanceConfigSubscription(w http.ResponseWriter, r *http.Request, params PostInstanceConfigSubscriptionParams) {
	var (
		handlerName = "PostInstanceConfigSubscription"
		limit       int64
