...
func (t *Manager) worker() {
	...
	t.refreshSanPaths()
	t.updateIfChange()
	defer t.pub.Pub(&msgbus.NodeMonitorDeleted{Node: t.localhost}, t.labelLocalhost)
...
func (t *Manager) update() {
	...
	t.pub.Pub(&msgbus.NodeMonitorUpdated{Node: t.localhost, Value: *newValue.DeepCopy()}, t.labelLocalhost)
...
func (t *Manager) updateStats() {
	...
	t.pub.Pub(&msgbus.NodeStatsUpdated{Node: t.localhost, Value: *stats.DeepCopy()}, t.labelLocalhost)
}
...
func (t *Manager) refreshSanPaths() {
	...
	t.pub.Pub(&msgbus.NodeOsPathsUpdated{Node: t.localhost, Value: paths}, t.labelLocalhost)
}
...
func (t *Manager) publishNodeStatus() {
	...
	t.pub.Pub(&msgbus.NodeStatusUpdated{Node: t.localhost, Value: *t.nodeStatus.DeepCopy()}, t.labelLocalhost)
}
...
func (t *Manager) loadAndPublishConfig() error {
	...
	t.pub.Pub(&msgbus.NodeConfigUpdated{Node: t.localhost, Value: t.nodeConfig}, t.labelLocalhost)

	localNodeInfo := t.cacheNodesInfo[t.localhost]
	t.pub.Pub(&msgbus.NodeStatusLabelsUpdated{Node: t.localhost, Value: localNodeInfo.Labels.DeepCopy()}, t.labelLocalhost)
	...
	t.pub.Pub(&msgbus.NodeOsPathsUpdated{Node: t.localhost, Value: localNodeInfo.Paths.DeepCopy()}, t.labelLocalhost)
