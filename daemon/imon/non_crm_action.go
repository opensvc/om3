...
func (t *Manager) freeze() error {
	...
	t.pub.Pub(&msgbus.InstanceFrozenFileUpdated{Path: t.path, At: frozen}, t.pubLabels...)
	return nil
}
...
func (t *Manager) unfreeze() error {
	...
	t.pub.Pub(&msgbus.InstanceFrozenFileRemoved{Path: t.path, At: time.Now()}, t.pubLabels...)
	return nil
}
