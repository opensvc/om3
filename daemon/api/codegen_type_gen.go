...
// Valid indicates whether the value is a known member of the PatchItemKind enum.
func (e PatchItemKind) Valid() bool {
	switch e {
	case PacthItem:
		return true
	default:
...
// Valid indicates whether the value is a known member of the PatchListKind enum.
func (e PatchListKind) Valid() bool {
	switch e {
	case PatchListKindPatchList:
		return true
	default:
		return false
	}
...
type GetDaemonProcessParams struct {
	...
	// Selector execute on a list of objects
