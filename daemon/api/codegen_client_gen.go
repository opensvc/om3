...
func NewPostNodeActionSCSIScanRequest(server string, nodename InPathNodeName, params *PostNodeActionSCSIScanParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.Hba != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "hba", runtime.ParamLocationQuery, *params.Hba); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.Lun != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "lun", runtime.ParamLocationQuery, *params.Lun); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewPostDaemonAuditRequest(server string, nodename InPathNodeName, params *PostDaemonAuditParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.Preempt != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "preempt", runtime.ParamLocationQuery, *params.Preempt); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewGetDaemonEventsRequest(server string, nodename InPathNodeName, params *GetDaemonEventsParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.Replay != nil {
			...
			if queryFrag, err := runtime.StyleParamWithLocation("form", true, "replay", runtime.ParamLocationQuery, *params.Replay); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
